...
INSTANCE=datastax-enterprise-ubuntu-1804-bionic-v20200626

# You're going to want to ensure this image is built with the latest 18.04.  To check what that is, run:
#gcloud compute images list
#IMAGE_NAME=ubuntu-1804-bionic-v20200529
IMAGE_NAME=ubuntu-1804-bionic-v20200626
