...
gcloud compute disks create newimagedisk --image datastax-ubuntu-1404-trusty-v20160808 --image-project datastax-dev --project datastax-public --size 50  --zone us-central1-a
