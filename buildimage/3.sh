...
gcloud compute disks create newimagedisk --image datastax-ubuntu-1404-trusty-v20170901 --image-project fieldops-gce-presales --project datastax-public --size 20  --zone us-central1-a
...
gcloud compute images create datastax-ubuntu-1404-trusty-v20170901 --project datastax-public --source-disk newimagedisk --source-disk-zone us-central1-a --description datastax
